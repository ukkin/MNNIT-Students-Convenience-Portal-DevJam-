...
<form action="" method="post">
  <div class="container">
    <div class="left2"><h2>Fill the following information</h2><br></div>
   <div class="left2"> <p></p><br></div>
...
<b>Date of Birth : </b><input type="date" id="date" name="from"> 
...
{
  header('location: http://localhost/home.php', true, 307);       
          exit();
}
else
{
