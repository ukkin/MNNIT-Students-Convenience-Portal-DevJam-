...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 17, 2019 at 08:12 PM
...
(155, 20184081, 'Monday', 1, 2),
(156, 20184081, 'Tuesday', 4, 4),
(157, 20184081, 'Wednesday', 7, 7),
(158, 20184081, 'Thursday', 10, 10),
(159, 20184081, 'Friday', 13, 13),
(160, 20184081, 'Saturday', 16, 16),
(161, 20184081, 'Sunday', 19, 19),
...
--
ALTER TABLE `student_menu`
  MODIFY `sm_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=169;
