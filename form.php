...
<b>Name of events </b></b>:<br>  <textarea rows="4" cols="50" name="comment" font-size: 12pt>
All the events you will be taking part are to be mentioned here....</textarea>
  <br><br>
<b>Date of Event : </b><br><div class="left2"><input type="date" id="date" name="from"> <br><div class="left3"><div class="left4">
  TO</div> <input type="date" id="date" name="to"></div>
   <br><br></div>

<b>Comments : </b><br>

<textarea rows="4" cols="50" name="comment1">
Describe in brief why you should be considered as suitable candidade to get NOC....</textarea>
...
$query="INSERT INTO noc (College, Dramatics, Sports, Music, Athletics, Technical, Dance, Arts, Literary, Eventname, Startdate, Enddate, Comment) VALUES ('$college','$drams','$sports','$music','$athl','$tech','$dance','$arts','$lit','$eventn', '$sdate', '$edate', '$cmt')";
